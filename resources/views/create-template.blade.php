...
@section('title') New Template @endsection

@section('content')
<div class="w-full max-w-screen-xl mx-auto px-6 mt-2">
  <div class="container">
    <div class="mb-10 flex items-center">
      <h1 class="inline font-semibold text-3xl mr-auto">Create A New Template</h1> 
...
<div class="mt-4 w-full max-w-screen-xl mx-auto px-6">
  ...
  <div class="mt-4">
    <form method="post" action="{{ route('templates.store') }}" enctype="multipart/form-data" id="body-form">
        @csrf
