    ...
    public function run()
    {
        ...
        $entitys = [
            ...
            [
                ...
                'category' => 'dive',
                'island' => 'V. Fulidhoo',
                'name' => 'Fulidhoo Dive & Water Sports',
                'summary' => $this->summaries()[random_int(0,(count($this->summaries())-1))][0],
                'getting_here' => '',
                'average_price_currency' => '$',
                'longitude' => '15.232',
                ...
                'average_rating' => random_int(0,5),
                'average_price' => random_int(60,1000),
                'cover_image_url' => $imagePrefix . 'dive_shop1.jpg',
                'published' => true,
            ],
            [
                'id' => 13,
                ...
                'average_rating' => random_int(0,5),
                'average_price' => random_int(60,1000),
                'cover_image_url' => $imagePrefix . 'fuvahmulahkulhi.jpg',
                'published' => true,
            ],
            [
                'id' => 14,
                ...
                'average_rating' => random_int(0,5),
                'average_price' => random_int(60,1000),
                'cover_image_url' => $imagePrefix . 'fuvahmulahnaturepark.jpeg',
                'published' => true,
            ],
            [
                'id' => 15,
                ...
                'average_rating' => random_int(0,5),
                'average_price' => random_int(60,1000),
                'cover_image_url' => $imagePrefix . 'fuvahmulahthundi.jpg',
                'published' => true,
            ],
            [
                'id' => 16,
                ...
                'average_rating' => random_int(0,5),
                'average_price' => random_int(60,1000),
                'cover_image_url' => $imagePrefix . 'souvenir1.jpg',
                'published' => true,
            ],
            [
                'id' => 17,
                ...
                'average_rating' => random_int(0,5),
                'average_price' => random_int(60,1000),
                'cover_image_url' => $imagePrefix . 'souvenir2.jpg',
                'published' => true,
            ],
            [
                'id' => 18,
                ...
                'average_rating' => random_int(0,5),
                'average_price' => random_int(60,1000),
                'cover_image_url' => $imagePrefix . 'bridge.jpg',
                'published' => true,
            ],  
            [
                'id' => 19,
                ...
                'average_rating' => random_int(0,5),
                'average_price' => random_int(60,1000),
                'cover_image_url' => $imagePrefix . 'fridaymosque.jpg',
                'published' => true,
            ],
        ];
